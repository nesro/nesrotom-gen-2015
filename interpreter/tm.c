...
char * opCodeTab[] = { "HALT", "IN", "OUT", "ADD", "SUB", "MUL", "DIV", "INC",
		"DEC", "SHL", "SHR", "?RR",
		/* RR opcodes */
		"LD", "ST", "?RM", /* RM opcodes */
...
STEPRESULT stepTM(void) {
	...
	case opclRM:
		...
		if ((m < 0) || (m > DADDR_SIZE)) {
			fprintf(stderr, "nesrotom: m=%d DADDR_SIZE=%d reg[s]=%d "
					"iarg1=%d iarg2=%d iarg3=%d\n", m, DADDR_SIZE, reg[s],
					currentinstruction.iarg1, currentinstruction.iarg2,
					currentinstruction.iarg3);
			return srDMEM_ERR;
		}
		break;
